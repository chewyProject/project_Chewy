...
<title>Dog Food: Top Brands, Low Prices (Free Shipping) | Chewy</title>
...
<%-- 			  		</sql:query> --%>
			  		<c:forEach items="${sList }" var="cate">
				  		<div class="categoryEntry">
				  			<a class="categoryEntry_label" href="#food=${cate.bct_no }">${cate.sct_name }</a>
							...
							<div class="FacetEntry_checkboxContainer checkbox">
								<div class="checkbox_field">
									...
									<label for="checkbox-3" class="checkbox_label" >
										<div class="FacetEntry_facetEntryContainer">
											<a href class="FacetEntry_facetLabel">${brandList.b_no }</a>
		...
		<!------------------------------------ main ---------------------------------------------->
			...
			<div class="main-content col-md-7">
				<ol class="breadcrumb">
					...
					<li class="active breadcrumb-item">Food</li>
				</ol>
				
				<div class="ProductListHeader_headingDiv">
					<h1 class="ProductListHeader_headingText">Dog Food</h1>
				</div>
				
				<div class="banner">
					<a class="banner-item banner-short">
						<picture>
							<source media="(max-width: 648px)" srcset="https://cms-www.chewy.com/contentAsset/image/3c4977b5-7599-41c9-b309-0ea4119b971b/fileAsset/byInode/1/filter/Jpeg/jpeg_q/100/2022-04-NPM-Dog-Food-Standard-Updated-SMALL.jpg">
							<source media="(max-width: 1024px)" srcset="https://cms-www.chewy.com/contentAsset/image/cde97e90-6ed6-4f87-b3f8-eb90d69818e1/fileAsset/byInode/1/filter/Jpeg/jpeg_q/100/2022-04-NPM-Dog-Food-Standard-Updated-MEDIUM.jpg">
							<source media="(min-width: 1025px)" srcset="https://cms-www.chewy.com/contentAsset/image/c31f7af0-48ec-4f52-8117-f25879dfe5f3/fileAsset/byInode/1/filter/Jpeg/jpeg_q/100/2022-04-NPM-Dog-Food-Standard-Updated-LARGE.jpg">
							<img src="https://cms-www.chewy.com/contentAsset/image/c31f7af0-48ec-4f52-8117-f25879dfe5f3/fileAsset/byInode/1/filter/Jpeg/jpeg_q/100/2022-04-NPM-Dog-Food-Standard-Updated-LARGE.jpg" alt="National Pet Month. Reward your #1. Celebrate with savings on eats from top-rated brands by Chewy." class="banner__image" loading="lazy">
						</picture>
					</a>
				</div>
					...
					<div class="bxslider-content carousel_wrapper"> <!-- bx슬라이더 자리 -->
		 				<ul class="bxslider carousel_content">
		 					<c:forEach items="${sList }" var="bxList">
...
<!-- 		 					</li> -->
					...
					<div class="resultsSort">
						<p class="resultsCount">1 - 36 of 4158 Results</p>
							 ...
							 <div class="card col-sm-3 productCard">
							    ...
							    <div class="card-body product-card__content">
									...
									<a class="product-title" href="#">
										<strong class="card-title">${product.b_no }</strong> ${product.p_name }
									</a>
...
// 			autoControls : false,
	...
	function fn_prev(page, range, rangeSize, listSize, searchType) {	
		...
		var url = "/chewy/detailCateList.do";  // ajax로 값 넘기기
			url += "?page=" + page;
			url += "&range=" + range;
