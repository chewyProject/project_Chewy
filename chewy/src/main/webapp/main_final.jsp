...
.Shop_By_Pet_font .Popular_Categories_font, .Poppy_kitten_font, .Prescriptions_Delivered_header_font, .Explore_Top_Picks_font
.BrandsInStock_header_header, .BrandsInStock_header_font, .Discover_Pet_Favorites_By_Chewy_font
 {
...
/* 	margin: -1.6rem 0 0 -1.6rem; */
 ...
 .bd-placeholder-img {
  ...
  .Discover_Pet_Favorites_By_Chewy_slider {
  	display: flex;
  	margin: 0 auto;
  	list-style: none;
  }    
  
  .Discover_Pet_Favorites_By_Chewy_slider_list {
      margin: 0 0.5rem 0 0.5rem ;
  }
  
   .bx-wrapper .bx-pager, .bx-wrapper .bx-controls-auto {
  	position: absolute; left: 0; bottom: 15px; width:100%; text-align: center; 
  }
							...
							<div>
								<div class="row" style="height: 280px;">
									<ul class="bxslider_first">
										<li>
											<div><a href="https://www.chewy.com/b/autoship-save-15682">
												<img src="https://cms-www.chewy.com/contentAsset/image/5a39bce0-cbd6-47f2-a12a-0ab9c9728814/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-April-Autoship-HP-Hero-MEDIUM-1025.jpg" width="1440px" height="296px">
											</a></div>
											</li>
										<li>
											<div><a href="https://www.chewy.com/brands/justfoodfordogs-16614">
												<img src="https://cms-www.chewy.com/contentAsset/image/4d4e97fc-fc30-4cfa-81a3-a2a5807ae0ab/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-04-JFFD-HP-Hero-MEDIUM-1025-V2.jpg" width="1440px" height="296px">
											</a></div>
										</li>
										<li>
											<div><a href="https://www.chewy.com/b/pharmacy-2515">
												<img src="https://cms-www.chewy.com/contentAsset/image/5adbc167-1b10-4221-94d8-7d231de0cb94/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-03-Heartworm-Awareness-HP-Hero-MEDIUM-1025.jpg" width="1440px" height="296px">
											</a></div>
										</li>
										<li>
											<div><a href="https://www.chewy.com/app/content/connect-with-a-vet?utm_medium=bitly&utm_source=Chewy-HP&utm_campaign=Chewy-HP&utm_content=Chew-HP-Oct2021&utm_audience=Chewy-HP-Oct2021">
												<img src="https://cms-www.chewy.com/contentAsset/image/41fe6b13-a27b-4af7-9563-f1add7091199/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-02_CwaV-HP-Hero-April-DOG-Medium-1025.jpg" width="1440px" height="296px">
											</a></div>
										</li>
										<li>
											<div><a href="https://www.chewy.com/deals/todays-deals-2723">
												<img src="https://cms-www.chewy.com/contentAsset/image/606de30d-2269-4b12-b11b-5f2f7bb79163/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-04-NationalPetDay-HP-Hero-MEDIUM-1025-v2.jpg" width="1440px" height="296px">
											</a></div>
										</li>
										<li>
											<div><a href="https://www.chewy.com/b/disney-14155">
												<img src="https://cms-www.chewy.com/contentAsset/image/5bd9d5a4-2fc4-43e3-adb6-874d765a6560/fileAsset/byInode/1/filter/Resize,Jpeg/jpeg_q/100/resize_w/1025/resize_h/296/2022-Disney-HP-Hero-MEDIUM-2.jpg" width="1440px" height="296px">
											</a></div>
										</li>		
									</ul>						
								</div>
				...
				<div class="module">
					<section class="js">
						<div class="slider_bottom">
							<div class="row">
								<ul class="slider_bottom_grid">
									<li class="col-xs-6 col-md-3 slider_bottom_grid_li">
...
<!-- 		<div class="container"> -->
			<section class="chewy_home_content">
				<div class="module">
					<section class="js">
						<div class="ShopByPet">
							<header class="Shop_By_Pet_header">
							<h2 class="Shop_By_Pet_font">Shop By Pet</h2>
							</header>
							<div class="slideWrap">
								<div class="row">
									 <ul class="bxslider_second col-md-12">
										<li>
						...
						<div class="Discover_Pet_Favorites_By_Chewy">
							...
							<div class="container py-2">
								<ul class="Discover_Pet_Favorites_By_Chewy_slider">
									<li class="Discover_Pet_Favorites_By_Chewy_slider_list">
