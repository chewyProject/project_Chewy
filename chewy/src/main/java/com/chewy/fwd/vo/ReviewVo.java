...
public class ReviewVo {
	...
	public ReviewVo(int r_no, String r_nick, String r_title, String r_content, int r_star, int r_grade, String r_gcontent,
			String r_photo) {
		super();
		this.r_no = r_no;
		this.r_nick = r_nick;
	...
	public String toString() {
		return "ReviewVo [r_no=" + r_no + ", r_nick=" + r_nick + ", r_title=" + r_title + ", r_content=" + r_content
				+ ", r_star=" + r_star + ", r_r_grade=" + r_r_grade + ", r_gcontent=" + r_gcontent + ", r_photo=" + r_photo
				+ "]";
	}
